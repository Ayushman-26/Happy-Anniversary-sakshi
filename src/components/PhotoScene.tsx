...
import CouplePhoto from '../imgs/together.jpg'; // Add your couple photo here
  ...
  return (
    <SceneContainer ref={containerRef}>
      ...
      <TextContainer ref={textRef}>
        <MainTitle>Anniversary beats, heart to heart</MainTitle>
        <SubTitle>I love you bettuuu, from the start</SubTitle>
      </TextContainer>
    </SceneContainer>
  );
};
